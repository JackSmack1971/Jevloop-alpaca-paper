...
- Added pinned, credential-free GitHub Actions quality and Python 3.10–3.14 compatibility jobs, made Ruff merge-blocking after resolving the existing E701/E702 findings, and taught the package validator to reject missing/stale lockfiles and incomplete CI workflows.
